...
const SpaceStationRoutes = require('./routes/SpaceStation')
const ticketRoutes = require('./routes/DeliveredShipment')
...
app.use('/SpaceStation', SpaceStationRoutes)
//app.use('/DeliveredShipment', ticketRoutes)
